...
function setup() {
  ...
  register_nav_menus([
    'primary_navigation' => __('Primary Navigation', 'pure-demo'),
    'footer_links' => __('Footer Links', 'pure-demo')
  ]);
...
function display_sidebar() {
  ...
  isset($display) || $display = !in_array(true, [
    ...
    is_404(),
    //is_front_page(),
    is_page_template('full-width-template.php'),
    is_page_template('template-posts.php'),
  ]);
